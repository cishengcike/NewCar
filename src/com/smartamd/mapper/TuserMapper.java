...
public interface TuserMapper {
    ...
    List<Map<String, Object>> queryMapDriverPhone(@Param("lo") String lo_param, @Param("la") String la_param, @Param("kmNumber") String kmNumber_param);
...
//通过对应的类型查农机手
    ...
    //通过手机号查找农机手
    List<Map<String, Object>> queryMapDriverByPhone(@Param("lo") String lo_param, @Param("la") String la_param, @Param("phone") String phone);
